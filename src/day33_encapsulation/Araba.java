...
public class Araba {
    ...
    String marka="Marka belirtilmedi"; // marka'nin access modifier'i default oldugundan package icerisinde kullanilabilir
    ...
    // yakit'a ise deger atanamsin ama gorulebilsin (getter)
