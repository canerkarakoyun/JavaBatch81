...
public class C09_binarySearch {
    public static void main(String[] args) {
        /*
        Binary search methodu siralanmis array'de aradigimiz elementin indexini dondurur
        Ya aradigimiz element array'de yoksa o zaman ne yapacak;
        ...
        Arrays.sort(sayilar); // Array'in siralamasini kalici olarak degistirir
