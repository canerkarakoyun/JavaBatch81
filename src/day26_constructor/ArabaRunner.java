...
public class ArabaRunner {
    public static void main(String[] args) {
        ...
        access modifier'lari (public, private vs) da dikkate almaliyiz
         */
        Car car1=new Car();
        System.out.println(car1.fiyat);

        /*
        Araba class'indan bir obje olusturdugumda eger default constructor kullanildiyda
        ...
        Cunku; her class'da default constructor vardir ama parametresizdir.
