...
public class C03_PassByValue {
    public static void main(String[] args) {
        ...
        System.out.println("elemanDegistir methodu'ndan sonra list : "+list);

        listDegistir(list);

        System.out.println("listDegistir methodu'ndan sonra list : "+list);
    }
    ...
    public static void elemanlariDegistir(List<String> list) {
        ...
        System.out.println("elemanDegistir methodu'nda list :"+list);
    }
}
